...
function useSubidaSimple(
  endpoint: "fotoInspeccion" | "videoInspeccion" | "documentoInspeccion",
  archivos: string[],
...
/** Evidencia de la inspección: fotos, videos y documentos PDF — mismo
 * patrón que Diagnósticos, con los límites de la referencia (Bujía):
 * hasta 50 fotos, videos de hasta 100 MB, hasta 3 PDF. */
export function Evidencia({
  ...
  const {
    ...
    quitar: quitarFoto,
  } = useSubidaSimple("fotoInspeccion", fotos, onCambioFotos, onError);
  const {
    subiendo: subiendoVideos,
    recibir: recibirVideos,
    quitar: quitarVideo,
  } = useSubidaSimple("videoInspeccion", videos, onCambioVideos, onError);
  const {
    subiendo: subiendoDocumentos,
    recibir: recibirDocumentos,
    quitar: quitarDocumento,
  } = useSubidaSimple("documentoInspeccion", documentos, onCambioDocumentos, onError);
